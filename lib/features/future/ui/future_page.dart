    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Obx(
           ...
           Expanded(child: futureCon.pageIndex.value==0?LMEPage():futureCon.pageIndex.value==1?McxPage():futureCon.pageIndex.value==2?ShfePage():futureCon.pageIndex.value==3?TestScreen("Us Page"):futureCon.pageIndex.value==4?FXPage():RefRatePage())

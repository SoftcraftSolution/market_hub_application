...
import 'package:market_hub_application/features/alert/pages/economic_calender/ui/economic_calendar_page.dart';
import 'package:market_hub_application/features/alert/pages/hindi_news/ui/self_news_ui.dart';
            ...
            Expanded(
                ...
                child: Obx(
                  ()=> Padding(
                      ...
                      child: controller.pageIndex.value==0?LiveFeedPage():controller.pageIndex.value==1?SelfNewsPage():controller.pageIndex.value==2?SelfHindiNewsPage():controller.pageIndex.value==3?TechnicalAnalysisPage():controller.pageIndex.value==4?EconomicCalendarPage():CirculerPage()
                  ),
                )),
